...
public class Controller implements Observer {
    ...
    private ArrayList<Node> poolSocket = new ArrayList<>();
    ...
    void OpenServerOnMouseClicked(MouseEvent event) {
        byte[] ipBytes = {(byte)192,(byte)168,(byte)56, (byte)1 };
        InetAddress ip = null;
...
/*        finally {
    ...
    public void update(Observable o, Object arg) {
        ...
        if (o instanceof Server) {
            ...
            poolSocket.add(new Node(socket.hashCode(),"nodo"+poolSocket.size(),socket));
    ...
    private void broadCast(String mensaje){
        ...
        Node ultimaConexion = poolSocket.get(0);
        for (Node nodo: poolSocket) {
            try {
